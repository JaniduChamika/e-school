      ...
      <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
            <table class="table table-hover expandable-table">
                  ...
                  <tbody class="table-border-bottom-0 ">
                        ...
                        if (!empty($word)) {
                              // search officer by username , full name,contact,email or nic 
                              $q = $q . " WHERE (`username` LIKE '" . $word . "%' OR `fulname` LIKE '%" . $word . "%' OR `contact` LIKE '" . $word . "%' OR `email` LIKE '" . $word . "%' OR `nic_no` LIKE '" . $word . "%')";
                        }
                        if ($pen == "true" && !empty($word)) {
                              $q = $q . "AND  `state`='Pending'";
                        } else if ($pen == "true") {
                              $q = $q . "WHERE  `state`='Pending'";
                        }
                        // for pagination 
                        $number_per_page = 10;
                                    ...
                                    <td>
                                          <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                      ...
                                                      <a class="dropdown-item" href="officer-edit.php?uid=<?php echo $d["uid"] ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                                  ...
                                                                  <div>
                                                                        <div class="d-flex justify-content-between">
                                                                              ...
                                                                              <div class="expanded-table-normal-cell">
                                                                                    ...
                                                                                    ?>
                                                                                          <button class="btn btn-rounded rounded-circle  btn-icon p-2 text-white" id="lock" onclick="blockO(<?php echo $d['uid']; ?>,<?php echo $page ?>);" style="background-color: #EC255A;">
