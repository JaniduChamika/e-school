      ...
      <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
            <table class="table table-hover expandable-table">
                  ...
                  <tbody class="table-border-bottom-0 ">
                        ...
                        if (!empty($word)) {
                              // search by username,fullname,contact,email or nic 
                                    ...
                                    <td>
                                          <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                      ...
                                                      <a class="dropdown-item" href="admin-edit.php?uid=<?php echo $d["uid"] ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                                        ...
                                                                        <div class="d-flex justify-content-between">
                                                                              ...
                                                                              ?>
                                                                                    <div class="expanded-table-normal-cell">
                                                                                          ...
                                                                                          ?>
                                                                                                <button class="btn btn-rounded rounded-circle  btn-icon p-2 text-white" id="lock" onclick="blockA(<?php echo $d['uid']; ?>,<?php echo $page ?>);" style="background-color: #EC255A;">
