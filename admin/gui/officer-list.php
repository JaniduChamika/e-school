...
<head>
      ...
      <title>Admin | Officer List</title>
                                                      ...
                                                      <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                  <div class="d-none d-md-block col-md-4 col-lg-2">
                                                                        ...
                                                                        <input type="checkbox" class="btn-check " onchange="checkedinput();searchOfficer(1);" id="pendingbtn">
                                                                  </div>
                                                            </div>
                                                                  ...
                                                                  <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
                                                                        <table class="table table-hover expandable-table">
                                                                              ...
                                                                              <tbody class="table-border-bottom-0 ">
                                                                                    ...
                                                                                    $reult = DB::search("SELECT * FROM `officers` LIMIT $number_per_page OFFSET $offset");
                                                                                          ...
                                                                                          <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                      <span>
                                                                                                            ...
                                                                                                            if (empty($d["path"])) {
                                                                                                            ?>
                                                                                                                  <img src="../../image/profile/officer-default.png" alt="Avatar" class="rounded-circle" style="width: 40px;">
                                                                                                ...
                                                                                                <td>
                                                                                                      <div class="dropdown">
                                                                                                            ...
                                                                                                            <div class="dropdown-menu">
                                                                                                                  ...
                                                                                                                  <a class="dropdown-item" href="officer-edit.php?uid=<?php echo $d["uid"] ?>&title=officer"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                                                                                              ...
                                                                                                                              <div>
                                                                                                                                    <div class="d-flex justify-content-between">
                                                                                                                                          ...
                                                                                                                                          <div class="expanded-table-normal-cell">
                                                                                                                                                ...
                                                                                                                                                if ($d["state"] == "Blocked") {
                                                                                                                                                ?>
                                                                                                                                                      <button class="btn btn-rounded rounded-circle  btn-icon p-2 text-white unloackbtn" id="lock" onclick="unblockO(<?php echo $d['uid']; ?>,<?php echo $page ?>);">
                                                                                                                                                            <i class='bx bx-lock-open-alt'></i>
                                                                                                                                                      </button>
                                                                                                                                                <?php
                                                                                                                                                } else {
                                                                                                                                                ?>
                                                                                                                                                      <button class="btn btn-rounded rounded-circle  btn-icon p-2 text-white" id="lock" onclick="openBlockCom(<?php echo $d['uid']; ?>,<?php echo $page ?>,'o');" style="background-color: #EC255A;">
                                                                        ...
                                                                        <?php
                                                                              ...
                                                                              ?>
                                                                                    <li class="page-item prev">
                                                                                          <a class="page-link" href="javascript:void(0);" onclick="searchOfficer(<?php echo $page - 1 ?>);"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                                                                    </li>
                                                                                    <?php
                                                                              }
                                                                              ...
                                                                              for ($p = 1; $p <= $no_of_page; $p++) {
                                                                                    ...
                                                                                    ?>
                                                                                          <li class="page-item active">
                                                                                                <a class="page-link" href="javascript:void(0);" onclick="searchOfficer(<?php echo $p  ?>);"><?php echo $p ?></a>
                                                                                          </li>
                                                                                    <?php
                                                                                    } else {
                                                                                    ?>
                                                                              ...
                                                                              if ($no_of_page != $page && $no_of_page!=0) {
                                                                                    ...
                                                                                    <li class="page-item next">
                                                                                          <a class="page-link" href="javascript:void(0);" onclick="searchOfficer(<?php echo $page + 1 ?>);"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                                                                    </li>
                                                                              <?php
                                                                              }
                                                                              ?>
