...
?>
      ...
      <head>
            ...
            <title>Admin | 6-11 Class List</title>
                                    ...
                                    <div class="container-xxl flex-grow-1 container-p-y">
                                          <div class="row">
                                                ...
                                                <div class="col-12">
                                                      <!-- grade 1-5 -->
                                                      <div class="card mb-4">
                                                            <h5 class="card-header pb-2">Grades 6-11 Classes</h5>
                                                            <div class="row px-4">
                                                                  <div class="col-6  col-md-4 col-lg-3  ms-auto me-0">
                                                                        <select id="selectgrade" onchange="searchClass611(1);" class="form-select">
                                                                              <option value="0">Select Grade</option>
                                                                              <!-- load grades from db  -->
                                                                              <?php

                                                                              $reult = DB::search("SELECT * FROM `grade` WHERE `gname` IN (6,7,8,9,10,11)");
                                                                  ...
                                                                  <div class="table-responsive text-nowrap mb-4  overflow-auto scrollbar " style="min-height: 550px; max-height: 560px;">
                                                                        <table class="table table-hover">
                                                                              ...
                                                                              <tbody class="table-border-bottom-0">
                                                                                    ...
                                                                                    $pagination = DB::search("SELECT * FROM `allclass` WHERE `grade` IN (6,7,8,9,10,11)");
                                                                                    ...
                                                                                    $reult = DB::search("SELECT * FROM `allclass` WHERE `grade` IN (6,7,8,9,10,11)  ORDER BY `clz_name` ASC LIMIT $number_per_page OFFSET $offset");
                                                                        ...
                                                                        <ul class="pagination justify-content-center">
                                                                              ...
                                                                              ?>
                                                                                    <li class="page-item prev">
                                                                                          <a class="page-link" href="javascript:void(0);" onclick="searchClass611(<?php echo $page - 1 ?>);"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                                                                    </li>
                                                                                    <?php
                                                                              }
                                                                              ...
                                                                              for ($p = 1; $p <= $no_of_page; $p++) {
                                                                                    ...
                                                                                    ?>
                                                                                          <li class="page-item active">
                                                                                                <a class="page-link" href="javascript:void(0);" onclick="searchClass611(<?php echo $p  ?>);"><?php echo $p ?></a>
                                                                                          </li>
                                                                                    <?php
                                                                                    } else {
                                                                                    ?>
                                                                              ...
                                                                              if ($no_of_page != $page && $no_of_page != 0 && $no_of_page != 0) {
                                                                                    ...
                                                                                    <li class="page-item next">
                                                                                          <a class="page-link" href="javascript:void(0);" onclick="searchClass611(<?php echo $page + 1 ?>);"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                                                                    </li>
                                                                              <?php
                                                                              }
                                                                              ?>
                                                ...
                                                <div class="modal-dialog">
                                                      <form class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                  <div class="row">
                                                                        <div class="col mb-3">
                                                                              <label for="Assigntecher" class="form-label">Assign Teacher</label>
                                                                              <div class="input-group">
                                                                                    <select id="Assigntecher" class="form-select">
                                                                                          <option value="0">Select Teacher</option>
                                                                                          <?php
                                                                                          $result = DB::search("SELECT * FROM `user`  WHERE `user`.`uid` IN ( SELECT DISTINCT `user_uid` FROM  `teacher_has_grade`  INNER JOIN `grade` ON `teacher_has_grade`.`grade_gid`= `grade`.`gid` WHERE `grade`.`gname` BETWEEN 6 AND 11 ) ");
