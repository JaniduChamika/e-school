...
if (isset($_GET["uid"])) {
      $uid = $_GET["uid"];
      $result = DB::search("SELECT * FROM `officers` WHERE `uid`='" . $uid . "'");
...
?>
            ...
            <head>
                  ...
                  <title>Admin | Edit Officer Info</title>
                  <?php
                                                      ...
                                                      <div class="col-12 ">
                                                            <div class="card mb-4">
                                                                  <div class="card-header d-flex align-items-center justify-content-between">
                                                                        <h5 class="mb-0">Edit Officer Info</h5>
                                                                  ...
                                                                  <div class="card-body">
                                                                        ...
                                                                        <div class="row">
                                                                              ...
                                                                              <div class="col-12 text-end">
                                                                                    <button type="submit" class="btn btn-info" onclick="updateUser('officer',<?php echo $uid ?>);">Save</button>
                                                                              </div>
                                                                        </div>
