                                                      ...
                                                      <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                  <div class="d-none d-md-block col-md-4 col-lg-2">
                                                                        ...
                                                                        <input type="checkbox" class="btn-check " onchange="checkedinput();searchStudent(1);" id="pendingbtn">
                                                                  </div>
                                                                  <div class="col-6 col-md-4  ms-auto me-0">
                                                                        <select id="filterGrade" onchange="searchStudent(1);" class="form-select">
                                                                  ...
                                                                  <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
                                                                        <table class="table table-hover expandable-table">
                                                                              ...
                                                                              <tbody class="table-border-bottom-0 ">
                                                                                    ...
                                                                                    $reult = DB::search("SELECT * FROM `students` LIMIT $number_per_page OFFSET $offset");
                                                                                                ...
                                                                                                <td>
                                                                                                      <div class="dropdown">
                                                                                                            ...
                                                                                                            <div class="dropdown-menu">
                                                                                                                  ...
                                                                                                                  <a class="dropdown-item" href="student-edit.php?uid=<?php echo $d["uid"] ?>&title=student"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                                                                                              ...
                                                                                                                              <div>
                                                                                                                                    <div class="d-flex justify-content-between">
                                                                                                                                          ...
                                                                                                                                          <div class="expanded-table-normal-cell">
                                                                                                                                                ...
                                                                                                                                                if ($d["state"] == "Blocked") {
                                                                                                                                                ?>
                                                                                                                                                      <button class="btn btn-rounded btn-success rounded-circle  btn-icon p-2 text-white " id="lock" onclick="unblockS(<?php echo $d['uid']; ?>,<?php echo $page ?>);">
                                                                                                                                                            <i class='bx bx-lock-open-alt'></i>
                                                                                                                                                      </button>
                                                                                                                                                <?php
                                                                                                                                                } else {
                                                                                                                                                ?>
                                                                                                                                                      <button class="btn btn-rounded btn-danger rounded-circle  btn-icon p-2 text-white" id="lock" onclick="openBlockCom(<?php echo $d['uid']; ?>,<?php echo $page ?>,'s');">
