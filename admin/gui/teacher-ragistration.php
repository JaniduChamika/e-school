                                                ...
                                                <div class="col-12 ">
                                                      <div class="card mb-4">
                                                            <div class="card-header d-flex align-items-center justify-content-between">
                                                                  <h5 class="mb-0">Ragister Teacher</h5>
                                                            ...
                                                            <div class="card-body">
                                                                                          ...
                                                                                          <div class="row mb-3">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xxl-9">
                                                                                                      <div class="input-group input-group-merge">
                                                                                                            ...
                                                                                                            <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" id="usernametag" placeholder="TEC/ABJ/0001" aria-label="John Doe">
                                                                                                      </div>
                                                                                          ...
                                                                                          <div class="row mb-3">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xxl-9 ">
                                                                                                      ...
                                                                                                      <div class="row gy-1">
                                                                                                            ...
                                                                                                            ?>
                                                                                                                  <input type="checkbox" class="btn-check gradeTec  w-auto" name="<?php echo $d["gname"] ?>" onchange=" getRelevantSub();" value="<?php echo $d["gid"] ?>" id="grade<?php echo $i + 1 ?>">
                                                                  ...
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="col-12  text-end ">
                                                                              ...
                                                                              <button type="submit" class="btn btn-info mt-auto mb-0" id="submitbtn" onclick="addUser('teacher');">Submit &nbsp;
