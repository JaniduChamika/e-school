...
?>
      ...
      <head>
            ...
            <title>Admin | A/L Subject List</title>
            <?php
                                    ...
                                    <div class="container-xxl flex-grow-1 container-p-y">
                                          <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                      ...
                                                      <div class="card mb-4">
                                                            <h5 class="card-header pb-0">A/L Subjects</h5>
                                                            <div class="row px-4">
                                                                  <div class="col-6 col-md-4  col-lg-3 me-0 ms-auto">
                                                                        <select id="al-stream" onchange="searchSubjectal(1);" class="form-select">
                                                                  ...
                                                                  <div class="table-responsive text-nowrap overflow-auto scrollbar" style="min-height: 600px;max-height: 680px;">
                                                                        <table class="table table-hover">
                                                                              ...
                                                                              <tbody class="table-border-bottom-0">
                                                                                    ...
                                                                                    $pagination = DB::search("SELECT * FROM `allsubject`  WHERE `sub_grade_type`=1213 ");
                                                                                    ...
                                                                                    $reult = DB::search("SELECT * FROM `allsubject` WHERE `sub_grade_type`=1213  ORDER BY `sub_name` ASC LIMIT $number_per_page OFFSET $offset");
