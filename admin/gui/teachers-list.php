                                                            ...
                                                            <div class="card-body">
                                                                  ...
                                                                  <div class="row">
                                                                        <div class="d-none d-md-block col-md-4 col-lg-2">
                                                                              ...
                                                                              <input type="checkbox" class="btn-check " onchange="checkedinput();searchTeacher(1);" id="pendingbtn">
                                                                        </div>
                                                                        <div class="col-6 col-md-4  col-lg-3 offset-lg-4">
                                                                              <select id="filterGrade" onchange="searchTeacher(1);" class="form-select">
                                                                        ...
                                                                        <div class="col-6 col-md-4  col-lg-3">
                                                                              ...
                                                                              <select id="filterSub" onchange="searchTeacher(1);" class="form-select">
                                                                        ...
                                                                        <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
                                                                              <table class="table table-hover expandable-table">
                                                                                    ...
                                                                                    <tbody class="table-border-bottom-0 ">
                                                                                          ...
                                                                                          $pagination = DB::search("SELECT * FROM `teachers`");
                                                                                          ...
                                                                                          $reult = DB::search("SELECT * FROM `teachers` LIMIT $number_per_page OFFSET $offset");
                                                                                                      ...
                                                                                                      <td>
                                                                                                            <div class="dropdown">
                                                                                                                  ...
                                                                                                                  <div class="dropdown-menu">
                                                                                                                        ...
                                                                                                                        <a class="dropdown-item" href="teacher-edit.php?uid=<?php echo $d["uid"] ?>&title=teacher"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                                                                                                    ...
                                                                                                                                    <div>
                                                                                                                                          <div class="d-flex justify-content-between">
                                                                                                                                                ...
                                                                                                                                                <div class="expanded-table-normal-cell">
                                                                                                                                                      ...
                                                                                                                                                      ?>
                                                                                                                                                            <button class="btn btn-rounded rounded-circle  btn-icon p-2 text-white" id="lock" onclick="openBlockCom(<?php echo $d['uid']; ?>,<?php echo $page ?>,'t');" style="background-color: #EC255A;">
