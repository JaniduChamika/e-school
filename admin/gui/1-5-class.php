...
?>
      ...
      <head>
            ...
            <title>Admin | 1-5 Class List</title>
                                    ...
                                    <div class="container-xxl flex-grow-1 container-p-y">
                                          <div class="row">
                                                ...
                                                <div class="col-12">
                                                      <!-- grade 1-5 -->
                                                      <div class="card mb-4">
                                                            <h5 class="card-header pb-2">Grades 1-5 Classes</h5>
                                                            <div class="row px-4">
                                                                  <div class="col-6  col-md-4 col-lg-3  ms-auto me-0">
                                                                        <select id="selectgrade" onchange="searchClass15(1);" class="form-select">
                                                                              <option value="0">Select Grade</option>
                                                                              <!-- load grades from db  -->

                                                                              <?php

                                                                              $reult = DB::search("SELECT * FROM `grade` WHERE `gname` IN (1,2,3,4,5)");
                                                            ...
                                                            <div class="card-body pt-0" id="tableBox">
                                                                  ...
                                                                  <div class="table-responsive text-nowrap mb-4  overflow-auto scrollbar " style="min-height: 550px; max-height: 560px;">
                                                                        <table class="table table-hover">
                                                                              ...
                                                                              <tbody class="table-border-bottom-0">
                                                                                    ...
                                                                                    $pagination = DB::search("SELECT * FROM `allclass` WHERE `grade` IN (1,2,3,4,5)");
                                                                                    ...
                                                                                    $reult = DB::search("SELECT * FROM `allclass` WHERE `grade` IN (1,2,3,4,5) ORDER BY `clz_name` ASC LIMIT $number_per_page OFFSET $offset");
                                                                        ...
                                                                        <div class="col mb-3">
                                                                              ...
                                                                              <div class="input-group">
                                                                                    <select id="Assigntecher" class="form-select">
                                                                                          ...
                                                                                          <?php
                                                                                          $result = DB::search("SELECT * FROM `user`  WHERE `user`.`uid` IN ( SELECT DISTINCT `user_uid` FROM  `teacher_has_grade`  INNER JOIN `grade` ON `teacher_has_grade`.`grade_gid`= `grade`.`gid` WHERE `grade`.`gname` BETWEEN 1 AND 5 ) ");
                                          ...
                                          <!-- assign teacher  modal end -->
                                          <!-- rename class modal start  -->
