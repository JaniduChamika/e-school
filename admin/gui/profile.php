...
if (isset($_SESSION["admin"])) {
      ...
      $result = DB::search("SELECT * FROM `admins` WHERE `uid`='" . $admin["uid"] . "'");
                                                            ...
                                                            <div class="card-body">
                                                                  <div class="row">
                                                                        <div class="col-12 col-lg-6 text-center " id="imageviewbox">
                                                                              <label for="selectImage3" onclick="done();">
                                                                                    ...
                                                                                    if (empty($data["path"])) {
                                                                                    ?>
                                                                                          <div class="serviceImageBox mb-2" id="viewImage3" style="background-image: url('../../image/profile/admin-default.png');">
                                                                                          ...
                                                                                          ?>
                                                                                                ...
                                                                                                ?>
                                                                                                <input type="file" class="d-none" accept=".png, .jpg, .jpeg" id="selectImage3" disabled />
                                                                                                </div>
                                                                              </label>


                                                                        </div>
                                                                        <div class="col-12 col-lg-6  d-none mb-2" id="cropbox">
                                                                                          ...
                                                                                          <div class="row mb-3">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xxl-9">
                                                                                                      <div class="input-group input-group-merge">
                                                                                                            ...
                                                                                                            <!-- <button  class="btn input-group-buttone btn-info">Request</button> -->
                                                                                                      </div>
                                                                                          ...
                                                                                          <div class="row mb-3">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xxl-9">
                                                                                                      <div class="input-group input-group-merge">
                                                                                                            ...
                                                                                                            <input type="text" id="nictag" value="<?php echo $data["nic_no"] ?>" class="form-control phone-mask" placeholder="200*******09" disabled>
                                                                                                      </div>
                                                                                                </div>
                                                                                          </div>
                                                                                    </div>
                                                                  ...
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="col-12 text-end">
                                                                              ...
                                                                              <button type="submit" class="btn btn-info" onclick="profileEdiAdmin();" id="editbtn">Edit</button>
