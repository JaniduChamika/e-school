                                                ...
                                                <div class="col-12 ">
                                                      <div class="card mb-4">
                                                            <div class="card-header d-flex align-items-center justify-content-between">
                                                                  <h5 class="mb-0">Ragister Admin</h5>
                                                            ...
                                                            <div class="card-body">
                                                                        ...
                                                                        <div class="col-12 text-center " id="imageviewbox">
                                                                              <label for="selectImage3" onclick="done();">
                                                                                    <div class="serviceImageBox mb-2" id="viewImage3" style="background-image: url('../../image/profile/admin-default.png');">
                                                                                          <input type="file" class="d-none" accept=".png, .jpg, .jpeg,.svg" id="selectImage3" />
                                                                                          ...
                                                                                          <div class="row mb-3">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xxl-9">
                                                                                                      <div class="input-group input-group-merge">
                                                                                                            ...
                                                                                                            <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" id="usernametag" placeholder="AD/ABJ/0001" aria-label="John Doe">
                                                                                                      </div>
                                                                                          ...
                                                                                          <div class="row mb-3">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xxl-9">
                                                                                                      <div class="input-group input-group-merge">
                                                                                                            ...
                                                                                                            <input type="text" id="nictag" class="form-control phone-mask" placeholder="200*******09">
                                                                                                      </div>
                                                                                                </div>
                                                                                          </div>
                                                                                    </div>
                                                                  ...
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="col-12  text-end ">
                                                                              ...
                                                                              <button type="submit" class="btn btn-info mt-auto mb-0" id="submitbtn" onclick="addUser('admin');">Submit
