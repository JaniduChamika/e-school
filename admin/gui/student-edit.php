...
if (isset($_GET["uid"])) {
      $uid = $_GET["uid"];
      $result = DB::search("SELECT * FROM `students` WHERE `uid`='" . $uid . "'");
...
?>
            ...
            <head>
                  ...
                  <title>Admin | Edit Student Info</title>
                  <?php
                                                      ...
                                                      <div class="col-12 ">
                                                            <div class="card mb-4">
                                                                  <div class="card-header d-flex align-items-center justify-content-between">
                                                                        <h5 class="mb-0">Edit Student Info</h5>
                                                                  ...
                                                                  <div class="card-body">
                                                                        <div class="row">
                                                                              ...
                                                                              <!-- load grades from db  -->
                                                                                                                        ...
                                                                                                                        $reult = DB::search("SELECT * FROM `grade` ORDER BY `gname` ASC");

                                                                                                                        for ($i = 0; $i < $reult->num_rows; $i++) {
                                                                                                                              $d = $reult->fetch_assoc();
                                                                                                                              if ($data["grade"] == $d["gname"]) {
                                                                                                                        ?>
                                                                                                                                    <option value="<?php echo $d["gid"] ?>" selected><?php echo $d["gname"] ?></option>
                                                                                                      ...
                                                                                                      <div class="col-md-8 col-xxl-9">
                                                                                                            <div class="input-group input-group-merge">
                                                                                                                  ...
                                                                                                                  <select id="classtag" class="form-select">
                                                                                                                        ...
                                                                                                                        $reult = DB::search("SELECT * FROM `class` ORDER BY `clz_name` ASC");

                                                                                                                        for ($i = 0; $i < $reult->num_rows; $i++) {
                                                                                                                              $d = $reult->fetch_assoc();
                                                                                                                              if ($data["clz_name"] == $d["clz_name"]) {
                                                                                                                                    ?>
                                                                                                                                    <option value="<?php echo $d["clz_id"] ?>" selected><?php echo $d["clz_name"] ?></option>
                                                                                                                              <?php
                                                                                                                              }else{
                                                                                                                                    ?>
                                                                                          ...
                                                                                          <div class="col-12 col-md-6">
                                                                                                ...
                                                                                                <div class="row mb-3">
                                                                                                      ...
                                                                                                      <div class="col-md-8 col-xxl-9">
                                                                                                            <div class="input-group input-group-merge">
                                                                                                                  <span class="input-group-text"><i class="bx bx-user"></i></span>
                                                                                                                  <input type="text" id="gardian-name" value="<?php echo $data["guardian_name"] ?>" class="form-control phone-mask" placeholder="Mr. Gunathilaka">
                                                                                                            </div>
                                                                                                      </div>
                                                                                                </div>
                                                                                          </div>
                                                                                          <div class="col-12 col-md-6">
                                                                                                ...
                                                                                                <div class="row mb-3">
                                                                                                      ...
                                                                                                      <div class="col-md-8 col-xxl-9">
                                                                                                            <div class="input-group input-group-merge">
                                                                                                                  <span class="input-group-text"><i class="bx bx-phone"></i></span>
                                                                                                                  <input type="text" id="gardian-contact"  value="<?php echo $data["guardian_contact"] ?>" class="form-control phone-mask" placeholder="07# 7777 8###">
                                                                                                            </div>
                                                                                                      </div>
                                                                                                </div>
                                                                                          </div>
                                                                        ...
                                                                        <div class="row">
                                                                              ...
                                                                              <div class="col-12 text-end">
                                                                                    <button type="submit" class="btn btn-info" onclick="updateUser('student',<?php echo $uid ?>);">Save</button>
                                                                              </div>
                                                                        </div>
