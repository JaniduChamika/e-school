                                                                        ...
                                                                        <table class="table table-hover expandable-table">
                                                                              <thead>
                                                                                    <tr>
                                                                                          ...
                                                                                          <th class="ps-3">Teacher Username</th>
                                                                                                ...
                                                                                                <td>
                                                                                                      <div class="dropdown">
                                                                                                            ...
                                                                                                            <div class="dropdown-menu">
                                                                                                                  ...
                                                                                                                  <a class="dropdown-item" href="javascript:void(0);"><i class='bx bx-show-alt'></i> View</a>
                                                                                                                  <!-- <a class="dropdown-item" href="javascript:void(0);"><i class='bx bx-hide' ></i> Hide</a> -->
                                                                                                            </div>
                                                                                                      </div>
                                                                                                </td>
                                                                                          </tr>
