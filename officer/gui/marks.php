...
?>
      ...
      <head>
            ...
            <title>Officer | Assignment Marks </title>
                                                            ...
                                                            <div class="card-body">
                                                                  ...
                                                                  <div class="row">
                                                                        <div class="d-none d-md-block col-md-4 col-lg-2">
                                                                              ...
                                                                              <input type="checkbox" class="btn-check " onchange="checkedinput();searchAssignmentMark(1);" id="pendingbtn">
                                                                        </div>
                                                                        <div class="col-6  col-md-4 col-lg-3  ms-auto me-0">
                                                                              <select id="selectgrade" onchange="searchAssignmentMark(1);" class="form-select">
                                                                        ...
                                                                        <div class="col-6  col-md-4 col-lg-3">
                                                                              ...
                                                                              <select id="selectsub" onchange="searchAssignmentMark(1);" class="form-select">
                                                                        ...
                                                                        <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
                                                                              <table class="table table-hover expandable-table">
                                                                                    ...
                                                                                    <tbody class="table-border-bottom-0 ">
                                                                                          ...
                                                                                          $pagination = DB::search("SELECT * FROM `stu_assignment_awnser` WHERE `status`!='3'");
                                                                                          ...
                                                                                          $result = DB::search("SELECT * FROM `stu_assignment_awnser`  WHERE `status`!='3' LIMIT $number_per_page OFFSET $offset");
