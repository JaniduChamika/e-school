    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <div class="navbar-nav align-items-center">
            <div class="nav-item d-flex align-items-center">
                ...
                if ($curPageName == "student-list.php") {
                ?>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <?php
                        $imgp = DB::search("SELECT * FROM `profile_image` WHERE `user_uid`='" . $_SESSION["officer"]["uid"] . "'");
                        $imgd;
                        if ($imgp->num_rows == 1) {
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    ?>
                                        ...
                                        <small class="text-muted">Academic Officer</small>
                                    <?php
                        ...
                        <a class="dropdown-item" href="#">
                            <span class="d-flex align-items-center align-middle">
                                ...
                                <span class="flex-shrink-0 badge badge-center rounded-pill bg-danger w-px-20 h-px-20">
                                    <?php
                                    $noti = DB::search("SELECT * FROM `notification` WHERE `user_type` IN (4)");
                                    echo $noti->num_rows;
                                    ?>
                                </span>
                            </span>
