...
if (isset($_SESSION["officer"])) {
      $offier = $_SESSION["officer"];
      $result = DB::search("SELECT * FROM `officers` WHERE `uid`='" . $offier["uid"] . "'");
                                                            ...
                                                            <div class="card-body">
                                                                  ...
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="col-12 text-end">
                                                                              <button type="submit" class="btn btn-info" onclick="profileEdiOfficer();" id="editbtn">Edit</button>
                                                                        </div>
                                                                  </div>
