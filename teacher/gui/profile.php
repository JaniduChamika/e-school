...
if (isset($_SESSION["teacher"])) {
      ...
      $result = DB::search("SELECT * FROM `teachers` WHERE `uid`='" . $teacher["uid"] . "'");
                                                            ...
                                                            <div class="card-body">
                                                                        ...
                                                                        <div class="col-12 col-lg-6">
                                                                              <div class="row p-3">
                                                                                    <div class="col-lg-12 text-center text-lg-start">
                                                                                          ...
                                                                                          <span class="form-text">NIC <span class="d-none d-lg-inline-block">: -</span> </span>
                                                                                          <p class="mb-1"><?php echo $data["nic_no"] ?></p>

                                                                                          <span class="form-text">Subject(s) You Teach <span class="d-none d-lg-inline-block">: -</span> </span>
                                                                                          <p class="mb-1">
                                                                                                <?php
                                                                                                $sub = DB::search("SELECT * FROM `teacher_has_subject` INNER JOIN `subject` ON `teacher_has_subject`.`subject_id`=`subject`.`sub_id` WHERE `user_uid`='" . $teacher["uid"] . "'");
                                                                                                if ($sub->num_rows >= 1) {
                                                                                                      for ($i = 0; $i < $sub->num_rows; $i++) {
                                                                                                            $subd = $sub->fetch_assoc();
                                                                                                            if ($i == 0) {
                                                                                                                  echo $subd["sub_name"];
                                                                                                            } else {
                                                                                                                  echo ", " . $subd["sub_name"];
                                                                                          ...
                                                                                          <span class="form-text">Grade(s) You Teach <span class="d-none d-lg-inline-block">: -</span> </span>
                                                                                          <p class="mb-1">
                                                                                                <?php
                                                                                                $grad = DB::search("SELECT * FROM `teacher_has_grade` INNER JOIN `grade` ON `teacher_has_grade`.`grade_gid`=`grade`.`gid` WHERE `user_uid`='" . $teacher["uid"] . "'");
                                                                                                if ($grad->num_rows >= 1) {
                                                                                                      for ($i = 0; $i < $grad->num_rows; $i++) {
                                                                                                            $gradD = $grad->fetch_assoc();
                                                                                                            if ($i == 0) {
                                                                                                                  echo $gradD["gname"];
                                                                                                            } else {
                                                                                                                  echo ", " . $gradD["gname"];
                                                                  ...
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="col-12 text-end">
                                                                              <button type="submit" class="btn btn-info" onclick="profileEdiTeacher();" id="editbtn">Edit</button>
                                                                        </div>
                                                                  </div>
