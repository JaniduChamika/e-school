                                                            ...
                                                            <div class="row">
                                                                  <div class="col-12">
                                                                        <div class="row">
                                                                              ...
                                                                              <?php
                                                                              $isdark = DB::search("SELECT * FROM `dark_theam` WHERE `user_uid`='" . $_SESSION["teacher"]["uid"] . "'");
                                                                              if ($isdark->num_rows == 1) {
                                                                              ?>
                                                                                    <div class="col-3 col-lg-2 form-check">
                                                                                          <input class="form-check-input" name="theam" onchange="Lighttheam('teacher');" type="radio" id="lighttheam">
                                                                                          <label class="form-check-label" for="lighttheam"> Light </label>

                                                                                    </div>
                                                                                    <div class="col form-check">
                                                                                          <input class="form-check-input" name="theam" onchange="darktheam('teacher');" type="radio" id="darktheam" checked>
                                                                              ...
                                                                              ?>
                                                                                    <div class="col-3 col-lg-2 form-check">
                                                                                          <input class="form-check-input" name="theam" onchange="Lighttheam('teacher');" type="radio" id="lighttheam" checked>
                                                                                          <label class="form-check-label" for="lighttheam"> Light </label>

                                                                                    </div>
                                                                                    <div class="col form-check">
                                                                                          <input class="form-check-input" name="theam" onchange="darktheam('teacher');" type="radio" id="darktheam">
                                                                                          <label class="form-check-label" for="darktheam"> Dark </label>
                                                                        ...
                                                                        <div class="row pt-2">
                                                                              ...
                                                                              <div class="col form-check form-switch mb-2">
                                                                                    <?php
                                                                                    $user = DB::search("SELECT * FROM `user` WHERE `uid`='" . $_SESSION["teacher"]["uid"] . "'");
                                                                                    if ($user->num_rows == 1) {
                                                                                          $userD = $user->fetch_assoc();
                                                                                          if ($userD["tsv_status"] == 1) {
                                                                                    ?>

                                                                                                <input class="form-check-input" type="checkbox" onchange="twoStepVerify('teacher');" id="verifiyid" checked="">
                                                                                                <label class="form-check-label" for="verifiyid">ON</label>
                                                                                          <?php
                                                                                          } else {
                                                                                          ?>

                                                                                                <input class="form-check-input" type="checkbox" onchange="twoStepVerify('teacher');" id="verifiyid">
                                                      ...
                                                      <div class="card-body">
                                                            <div class="row">
                                                                  ...
                                                                  <div class="col-12 text-end">
                                                                        <button type="submit" class="btn btn-info " onclick="resetPws('teacher');">Save</button>
