                                                ...
                                                <div class="col-xxl-6 ">
                                                      <div class="card mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                  ...
                                                                  <label class="form-label d-block mt-2" for="grade">Grade</label>
                                                                  ...
                                                                  <label class="form-label d-block mt-2" for="subject">Select Subject</label>
                                                                  ...
                                                                  <label class="form-label d-block mt-2" for="medium">Select Medium</label>
                                                                  ...
                                                                  <label class="form-label d-block mt-2" for="notetitle">Note Title </label>

                                                                  <div class="input-group">
                                                                        <input type="text" class="form-control" id="notetitle" placeholder="Enter Note Title">
                                                                        <button class="btn btn-info" type="button" onclick="addNote();">Add</button>
                                                                  </div>
                                                                  <div class="row pt-3">
