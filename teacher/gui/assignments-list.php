...
?>
      ...
      <head>
            ...
            <title>Teacher | Assignments List</title>
                                                            ...
                                                            <div class="card-body">
                                                                  ...
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="d-none d-md-block col-md-4 col-lg-2">
                                                                              ...
                                                                              <input type="checkbox" class="btn-check " onchange="checkedinputact();searchAssingment(1);" id="activetag">
                                                                        </div>
                                                                        <div class="col-6  col-md-4 col-lg-3  ms-auto me-0">
                                                                              <select id="selectgrade" onchange="searchAssingment(1);" class="form-select">
                                                                        ...
                                                                        <div class="col-6  col-md-4 col-lg-3">
                                                                              ...
                                                                              <select id="selectsub" onchange="searchAssingment(1);" class="form-select">
                                                                        ...
                                                                        <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
                                                                              <table class="table table-hover expandable-table">
                                                                                    ...
                                                                                    <tbody class="table-border-bottom-0 ">
                                                                                          ...
                                                                                          $pagination = DB::search("SELECT * FROM `assingment_view` WHERE `uid`='" . $teacherId . "'");
                                                                                          ...
                                                                                          $result = DB::search("SELECT * FROM `assingment_view`  WHERE `uid`='" . $teacherId . "' LIMIT $number_per_page OFFSET $offset");
                                                ...
                                                <div class="modal-dialog">
                                                      <form class="modal-content">
                                                            <div class="modal-header">
                                                                  <h5 class="modal-title" id="backDropModalTitle">Edit Date</h5>
                                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                  <div class="row">
                                                                        <div class="col mb-3">
                                                                              <label for="editdate" class="form-label">Select Start Date</label>
                                                                              <input type="date" id="startdate" class="form-control">
                                                                        </div>
                                                                        <div class="col mb-3">
                                                                              <label for="editdate" class="form-label">Select End Date</label>
                                          ...
                                          <div class="modal fade " id="delteMod" data-bs-backdrop="static" tabindex="-1" aria-modal="true" role="dialog">
                                                <div class="modal-dialog modal-dialog-centered">
                                                      <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">You cannot get back this file once you deleted. Are your sure you want to delete this assingment?</div>
                                                            <div class="modal-footer">
