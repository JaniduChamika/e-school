                                                                              ...
                                                                              <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
                                                                                    <table class="table table-hover expandable-table">
                                                                                          ...
                                                                                          <tbody class="table-border-bottom-0 ">
                                                                                                ...
                                                                                                $pagination = DB::search("SELECT * FROM `note_view` WHERE `gid`='" . $student["gid"] . "'");
                                                                                                ...
                                                                                                $result = DB::search("SELECT * FROM `note_view`  WHERE `gid`='" . $student["gid"] . "' LIMIT $number_per_page OFFSET $offset");
