      ...
      <div class="table-responsive text-nowrap mb-4 scrollbar" style="min-height: 550px;max-height: 550px;">
            <table class="table table-hover expandable-table">
                  ...
                  <tbody class="table-border-bottom-0 ">
                        <?php
                        // get not acroding to student grade 

                        $q = "SELECT * FROM `note_view` WHERE `gid`='" . $student["gid"] . "'";
                        ...
                        if (!empty($word)) {
                              $q = $q . " AND (`note_id` LIKE '" . $word . "%' OR `title` LIKE '" . $word . "%' OR `sub_name` LIKE '" . $word . "%' OR `fulname` LIKE '%" . $word . "%' )";
                        }
