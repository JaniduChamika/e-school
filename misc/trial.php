...
if (isset($_SESSION["student"])) {
      ...
      if ($_SESSION["pay_status"] == "selectTrial") {
?>
            <!DOCTYPE html>
            ...
            <body>
                  ...
                  <div class="card free-trial-popup d-flex justify-content-center align-items-center">
                        ...
                        <div class="trial-popup-section bg-white col-10 col-sm-8 col-md-7 col-lg-5 d-flex flex-column justify-content-center align-items-center " id="viewbox">
                              ...
                              <h3 class="trial-popup-heading font-weight-bold text-center">Start with 1 month Free-Trial</h3>
                              <p class="trial-text text-center">The trial period is valid for 1 month only. after the free trial period, you have to pay the student enrollment fee according to your grade. Thank You! </p>
                              <button class="btn btn-info" onclick="startTiral();">Start Free Trial</button>
                              <span>or</span>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                    <div class="modal-header">
                                          <h5 class="modal-title text-danger" id="modalToggleLabel">warning!</h5>
                                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">You alrady use 1 month trial period. If your hope to login your portal you have to pay the student enrollment fee according to your grade. Thank You!</div>
                                    <div class="modal-footer">

                                          <button class="btn btn-info" data-bs-target="#modalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">
                                                OK
                                          </button>
