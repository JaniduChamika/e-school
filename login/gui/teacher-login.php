        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body" id="loginbox">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Teacher Log In </h4>
              ...
              <div class="mb-3">
                <button class="btn btn-info  w-100 fw-bold" type="submit" id="logbtn" onclick="teacherLogin();">
            ...
            <div class="card-body d-none" id="vcbox">
              ...
              <button class="btn btn-info d-grid w-100" onclick="teacherLoginVC();">Log In
