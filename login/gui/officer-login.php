...
if (isset($_COOKIE["uno"])) {
  $username = $_COOKIE["uno"];
  $password = $_COOKIE["pwo"];
  $checked = "checked";
}
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body" id="loginbox">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Academic Officer Log In </h4>
              ...
              <div class="mb-3">
                <button class="btn btn-info d-grid w-100" type="submit" onclick="officerLogin();"> Log In</button>
              </div>
            ...
            <div class="card-body d-none" id="vcbox">
              ...
              <button class="btn btn-info w-100 fw-bold" id="logbtn" onclick="officerLoginVC();">
