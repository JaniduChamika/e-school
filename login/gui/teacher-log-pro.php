...
if (isset($_POST["un"])) {
      ...
      if (empty($un)) {
            ...
            $result = DB::search("SELECT * FROM `user` WHERE (`username`='" . $un . "' OR `email`='".$un."') AND `password`='" . $pw . "' AND `user_type`='3'");
            if ($result->num_rows == 1) {
                  $d = $result->fetch_assoc();
                  if ($d["status_sid"] == 1) {
                        if (isset($_POST["vc"])) {
                              $vc = $_POST["vc"];
                              $result2 = DB::search("SELECT * FROM `user` WHERE (`username`='" . $un . "' OR `email`='".$un."') AND `password`='" . $pw . "' AND `user_type`='3' AND `v_code`='" . $vc . "'");
                              if ($result2->num_rows == 1) {
                                    ...
                                    DB::iud("UPDATE `user` SET `status_sid`='2',`v_code`='' WHERE (`username`='" . $un . "' OR `email`='".$un."') AND `user_type`='3'");
                        ...
                        if ($d["tsv_status"] == 1) {
                              if (isset($_POST["vc"])) {
                                    ...
                                    if ($result2->num_rows == 1) {
                                          ...
                                          DB::iud("UPDATE `user` SET `v_code`='' WHERE (`username`='" . $un . "' OR `email`='".$un."') AND `user_type`='3'");
                                    ...
                                    DB::iud("UPDATE `user` SET `v_code`='" . $vc . "' WHERE (`username`='" . $un . "' OR `email`='".$un."') AND `user_type`='3'");
