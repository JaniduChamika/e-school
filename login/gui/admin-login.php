...
if (isset($_COOKIE["una"])) {
  $username = $_COOKIE["una"];
  $password = $_COOKIE["pwa"];
  $checked = "checked";
}
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body" id="loginbox">
              ...
              <div class="mb-3 form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="password" id="password" class="form-control" value="<?php echo $password ?>" placeholder="Enter your password" />
              ...
              <div class="mb-3">
                <button class="btn btn-info w-100 fw-bold" type="submit" id="logbtn" onclick="adminLogin()">
            ...
            <div class="card-body d-none" id="vcbox">
              ...
              <button class="btn btn-info d-grid w-100" onclick="adminLoginVC();">Log In</button>
